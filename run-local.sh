...
if [[ "$OSTYPE" == "darwin"* ]]; then
    TOOL_URL="https://github.com/allenk/GeminiWatermarkTool/releases/download/v0.3.2/GeminiWatermarkTool-macOS-Universal.zip"
    TOOL_NAME="GeminiWatermarkTool-macOS-Universal"
elif [[ "$OSTYPE" == "linux-gnu"* ]]; then
    TOOL_URL="https://github.com/allenk/GeminiWatermarkTool/releases/download/v0.3.2/GeminiWatermarkTool-Linux-x64.zip"
