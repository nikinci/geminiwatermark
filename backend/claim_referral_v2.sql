-- EXPLICIT Referral Claim Function (V5 - Email Fix)
-- Fixes NULL email by accepting email as argument.

create or replace function claim_referral_v2(code text, user_email text)
returns json as $$
declare
  referrer_id uuid;
...
GRANT EXECUTE ON FUNCTION claim_referral_v2(text, text) TO authenticated;
GRANT EXECUTE ON FUNCTION claim_referral_v2(text, text) TO service_role;
